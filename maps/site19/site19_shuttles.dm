...
/obj/effect/shuttle_landmark/heli/out
	...
	base_area = /area/site53/upper_surface/gatea2
...
/datum/shuttle/autodock/ferry/truck
	name = "MTF Truck"
//	sound_takeoff = 'sounds/effects/helicopter.ogg'
	warmup_time = 8
	shuttle_area = list(/area/site53/tram/mtf_truck)
	waypoint_station = "nav_mtf_truck_start"
	landmark_transition = "nav_mtf_truck_transition"
	waypoint_offsite = "nav_mtf_truck_out"
	move_time = 20

/obj/effect/shuttle_landmark/truck/start
	name = "MTF Truck Base"
	landmark_tag = "nav_mtf_truck_start"
	base_turf = /turf/unsimulated/floor/reinforced
	base_area = /area/site53/surface/surface

/obj/effect/shuttle_landmark/truck/out
	name = "Truck Site 53"
	landmark_tag = "nav_mtf_truck_out"
