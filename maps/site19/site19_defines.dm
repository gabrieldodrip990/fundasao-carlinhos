/datum/map/site19
	...
	empty_levels = list()
	accessible_z_levels = list("1"=1,"2"=2,"3"=3,"4"=4)
	base_turf_by_z = list(
	...
	usable_email_tlds = list("site19.foundation", "security.site19.foundation", "science.site19.foundation", "utility.site19.foundation")

	allowed_spawns = list("Cryogenic Storage", "D-Cells", "Light Containment Zone")
	default_spawn = "Cryogenic Storage"

	station_name  = "Foundation Site 19"
	station_short = "Site 19"
	...
	lobby_tracks = list(
		/decl/audio/track/blue_feather,
		/decl/audio/track/menu_cb,
		/decl/audio/track/satiate,
		/decl/audio/track/scpradio
	)
...
/obj/screen/new_player/title
	icon = 'maps/site19/icons/lobby.dmi'
	icon_state = "title_1"