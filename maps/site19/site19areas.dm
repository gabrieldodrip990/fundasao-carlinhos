...
/area/site53/llcz/lcz_control_room
	name = "\improper Light Containment Zone Control Room"
	area_flags = AREA_FLAG_RAD_SHIELDED
	icon_state = "checkpoint1"
...
/area/site53/uez/menssage
	name = "Menssage Server Room"
	icon_state = "SolarcontrolS"

/area/site53/uez/lougue
	name = "Lougue"
	icon_state = "bar"
...
/area/site53/upper_surface/gatea
	name = "Site 19 Gate A"
	icon_state = "hallC1"
	area_flags = AREA_FLAG_RAD_SHIELDED

/area/site53/surface/gates
	name = "Site 19 Gates Underground road"
	icon_state = "hallC1"
	requires_power = 0
	dynamic_lighting = 1
	area_flags = AREA_FLAG_RAD_SHIELDED

/area/site53/surface/gates2
	name = "Site 19 Gate Open Road"
	icon_state = "hallC2"
	requires_power = 0
	dynamic_lighting = 0
	area_flags = AREA_FLAG_RAD_SHIELDED

/area/site53/upper_surface/gatea2
	name = "Site 19 Gate A Helipad Entrace"
	icon_state = "hallC1"
	requires_power = 0
	dynamic_lighting = 1
	area_flags = AREA_FLAG_RAD_SHIELDED

/area/site53/lowertrams/ugatea
	name = "Gate A"
	icon_state = "hallC1"
	area_flags = AREA_FLAG_RAD_SHIELDED
	sound_env = LARGE_ENCLOSED

/area/site53/lowertrams/gatea_checkpoint
...
/area/site53/upper_surface/gateb
	name = "Gate B Entrace"
	icon_state = "hallC1"
	requires_power = 0
	dynamic_lighting = 1
